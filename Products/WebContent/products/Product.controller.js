...
//	},
	...
	create: function(){
		...
		//console.log(sap.ui.getCore().getModel('products').oData['Products('+0+')']);
		
		//console.log(sap.ui.getCore().getModel('products').oData);
		
		var webData = sap.ui.getCore().getModel('products').oData;
		console.log(webData);
		
		//var dat = sap.ui.getCore().getModel('products').oData;
		...
		$("#formId").slideDown(300,function(){
			...
			console.log(sap.ui.getCore().byId('tableId'));
		...
		// inicio comprobar id
			...
			do{
				...
				if(product == null)
				{
				  // aquí pegar código para guardar nueva fila
				} else {
	...
	save: function(){
		...
		if(this.mode == 'create' ){
			...
			var data = sap.ui.getCore().getModel('products').oData;
			var id = $("#id").val();
		
			//console.log(sap.ui.getCore().getModel('products').oData['Products('+0+')']);
			
			var idDatos = sap.ui.getCore().getModel('products').oData['Products('+id+')'];
